...
from medulla.package_server.server import P2PSite
from medulla.package_server.description import Description
from medulla.package_server.common import Common
from medulla.package_server.mirror_api import MirrorApi
from medulla.package_server.scheduler_api import SchedulerApi
from medulla.package_server.mirror import Mirror
from medulla.package_server.package_api_get import PackageApiGet
from medulla.package_server.package_api_put import PackageApiPut
from medulla.package_server.user_package_api import UserPackageApi
from medulla.package_server.imaging.api import ImagingApi
from medulla.package_server.imaging.pxe.server import PXEProxy

import medulla.xmlrpc
...
def initialize(config):
    ...
    try:
        if config.enablessl:
            medulla.xmlrpc.OpenSSLContext().setup(
            ...
            twisted.internet.reactor.listenSSL(
                ...
                contextFactory=medulla.xmlrpc.OpenSSLContext().getContext(),
            )
