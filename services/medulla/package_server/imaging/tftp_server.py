...
from medulla.package_server.imaging.api.functions import Imaging
...
class ImagingTFTPServer(object):
    ...
    def __init__(self):
        ...
        def file_handler(TFTPServerHandler, path):
            ...
            # Example path: /var/lib/medulla/imaging/bootmenus/0800275532AF
            try:
