...
"""
Medulla 2 Package Server Imaging API common functions
"""
...
from medulla.package_server.config import P2PServerCP as PackageServerConfig
from medulla.package_server.imaging.api.client import ImagingXMLRPCClient
from medulla.package_server.imaging.cache import UUIDCache
from medulla.package_server.imaging.api.status import Status
from medulla.package_server.imaging.menu import (
    isMenuStructure,
...
from medulla.package_server.imaging.computer import ImagingComputerConfiguration
from medulla.package_server.imaging.iso import ISOImage
from medulla.package_server.imaging.archiver import Archiver
from medulla.package_server.imaging.rpcreplay import RPCReplay

from medulla.utils import (
    isMACAddress,
    splitComputerPath,
    macToNode,
    isUUID,
...
from medulla.imaging.image import Medulla2Image
import json
import configparser
...
class Imaging(object, metaclass=SingletonN):
    ...
    def getComputerByMac(self, MACAddress):
        ...
        medulla.package_server.imaging.cache.UUIDCache()
    ...
    def imageGetLogs(self, imageUUID):
        ...
        if not isUUID(imageUUID):
            ...
            try:
                image = Medulla2Image(path, False)
                ret = image.logs
            except Exception as e:
                self.logger.error(
    ...
    def imagingServerISOCreate(self, imageUUID, size, title):
        """
        Create an ISO image corresponding to a Medulla 2 image.
    ...
    def check_process_multicast_finish(self, objprocess):
        ...
        pathfile = "/var/lib/medulla/imaging/masters/%s" % objprocess["uuidmaster"]
    ...
    def _listPartition(self, objprocess):
        ...
        try:
            ...
            objprocess["path"] = "/var/lib/medulla/imaging/masters/%s" % (
