...
"""
    Medulla2 Package server types
"""

from medulla.package_server.utilities import md5sum
import medulla.package_server.common
import urllib.parse
import locale
...
class AFiles:
    ...
    def toURI(self, mp=None):
        if mp is None:
            ...
            d = medulla.package_server.common.Common().h_desc(mp)
