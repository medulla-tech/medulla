...
from medulla.utils import isUUID, subnetForIpMask

if sys.platform != "win32":
    import pwd
    import grp
    from medulla.utils import Medulla2ConfigParser


class P2PServerCP(medulla.utils.Singleton):
    """
    Class to hold configuration directives
    """

    cacert = mmcconfdir + "/medulla/package-server/keys/cacert.pem"
    localcert = mmcconfdir + "/medulla/package-server/keys/privkey.pem"
    ...
    username = ""
    password = ""
    tmp_input_dir = "/var/lib/medulla/package-server-tmpdir"
    ...
    def setup(self, config_file):
        ...
        if self.cp.has_section("imaging_api") and self.cp.has_option(
            ...
            # base folder
            base_folder = "/var/lib/medulla/imaging"
            ...
            isos_folder = "/var/lib/medulla/imaging/isos"
