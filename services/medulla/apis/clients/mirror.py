...
from medulla.apis.consts import PULSE2_ERR_404, PULSE2_ERR_CONN_REF, PULSE2_ERR_UNKNOWN
from medulla.apis.consts import PULSE2_ERR_LOST, PULSE2_ERR_TIMEOUT

# need to get a PackageApiManager, it will manage a PackageApi for each mirror
# defined in the conf file.


class Mirror(Medulla2Api):
    errorback = None
    ...
    def __init__(self, base_mirror, fb_mirror=None):
        ...
        if fb_mirror:
            Medulla2Api.__init__(self, credentials, fb_mirror)
        else:
            Medulla2Api.__init__(self, credentials, mirror)
