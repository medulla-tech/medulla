...
from medulla.apis.clients import Medulla2Api
from medulla.utils import isMACAddress
import logging
...
class Imaging(Medulla2Api):
    def __init__(self, *attr):
        self.name = "Imaging"
        Medulla2Api.__init__(self, *attr)
    ...
    def computerRegister(
        ...
        """
        Called by medulla-imaging-server to tell the Package Server to
    ...
    def injectInventory(self, MACAddress, inventory):
        """
        Called by medulla-imaging-server to give the Package Server a new inventory from MACAddress.
        """
