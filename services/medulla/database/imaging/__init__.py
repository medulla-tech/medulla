...
from medulla.utils import isUUID
from medulla.database.dyngroup.dyngroup_database_helper import DyngroupDatabaseHelper
from medulla.database.imaging.types import P2ISS, P2IT, P2IM, P2IIK, P2ERR, P2ILL
...
class ImagingDatabase(DyngroupDatabaseHelper):
    """
    Class to query the Medulla2 imaging database.
