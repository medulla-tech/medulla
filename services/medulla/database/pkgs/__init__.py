...
# ORM mappings
from medulla.database.pkgs.orm.pakages import Packages
from medulla.database.pkgs.orm.extensions import Extensions
from medulla.database.pkgs.orm.dependencies import Dependencies
from medulla.database.pkgs.orm.syncthingsync import Syncthingsync
from medulla.database.pkgs.orm.package_pending_exclusions import (
    Package_pending_exclusions,
)

from medulla.database.pkgs.orm.pkgs_rules_algos import Pkgs_rules_algos
from medulla.database.pkgs.orm.pkgs_rules_global import Pkgs_rules_global
from medulla.database.pkgs.orm.pkgs_rules_local import Pkgs_rules_local
from medulla.database.pkgs.orm.pkgs_shares_ars import Pkgs_shares_ars
from medulla.database.pkgs.orm.pkgs_shares_ars_web import Pkgs_shares_ars_web
from medulla.database.pkgs.orm.pkgs_shares import Pkgs_shares
...
class PkgsDatabase(DatabaseHelper):
    ...
    def pkgs_register_synchro_package_multisharing(
        ...
        for relaydata in list_server_relay:
            if relaydata["jid"].startswith("rsmedulla@medulla/"):
                continue
