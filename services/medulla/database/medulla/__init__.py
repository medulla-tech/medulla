...
class Medulla2Database(DyngroupDatabaseHelper):
    """
    Singleton Class to query the medulla database.
    ...
    def activate(self, config):
        ...
        self.logger.info("Medulla2 database is connecting")
        self.config = config
        ...
        self.logger.debug(
            "Medulla2 database connected (version:%s)"
    ...
    def initMappers(self):
        """
        Initialize all SQLalchemy mappers needed for the medulla database
        """
