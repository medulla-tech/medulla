...
"""
The medulla manager, it give access to eveything that is stocked in the medulla database
"""
import logging
from medulla.utils import Singleton


class Medulla2Manager(Singleton):
    components = {}
    main = "medulla"
    ...
    def select(self, name):
        self.logger.info("Selecting medulla manager: %s" % name)
        self.main = name

    def register(self, name, klass):
        self.logger.debug("Registering medulla manager %s / %s" % (name, str(klass)))
...
class Medulla2I:
    def getPackageServerEntityByPackageServer(self, ps_uuid):
        """
        get the PackageServerEntity object as a dict from the main Medulla2Manager
        """
        pass
    ...
    def putPackageServerEntity(self, ps_uuid, e_uuid):
        """
        put the PackageServerEntity object in all the Medulla2Manager
        """
        pass
