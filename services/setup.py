...
setup(
    ...
    packages = [
        ...
        "mmc.plugins.glpi",
        "mmc.plugins.glpi.querymanager",
        "mmc.plugins.imaging",
        "mmc.plugins.inventory",
        "mmc.plugins.inventory.provisioning_plugins",
        "mmc.plugins.inventory.provisioning_plugins.network_to_entity",
        "mmc.plugins.inventory.querymanager",
        "mmc.plugins.msc",
        "mmc.plugins.msc.client",
        "mmc.plugins.pkgs",
        "mmc.plugins.pulse2",
        "pulse2",
        "pulse2.apis",
        "pulse2.apis.clients",
        "pulse2.database",
        "pulse2.database.dyngroup",
        "pulse2.database.imaging",
