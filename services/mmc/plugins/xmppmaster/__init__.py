...
def get_audit_summary_updates_by_entity(entity_uuid, start=0, limit=-1, filter="", history_type=""):
    return XmppMasterDatabase().get_audit_summary_updates_by_entity(entity_uuid, start, limit, filter, history_type)
