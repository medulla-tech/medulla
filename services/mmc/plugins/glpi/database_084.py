...
class Glpi084(DyngroupDatabaseHelper):
    ...
    def try_activation(self, config):
        ...
        if Version(self._glpi_version) >= Version("0.84") and Version(
            self._glpi_version
        ) < Version("0.85"):
    ...
    def initMappers(self):
        ...
        self.disk = Table("glpi_computerdisks", self.metadata, autoload_with=self.db)
        ...
        self.computersitems = Table(
            "glpi_computers_items", self.metadata, autoload_with=self.db
        )
