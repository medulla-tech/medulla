...
UPDATE BootService SET default_name = 'register', default_desc = 'Register as Medulla client', value = 'COM32 inventory.c32\nAPPEND dump_path=##PULSE2_INVENTORIES_DIR##' WHERE id = 2;
...
UPDATE Internationalization SET label = 'Als Medulla-Client registrieren' WHERE id = 5 AND fk_language = 4;
...
INSERT INTO Internationalization (id, label, fk_language) VALUES (43, 'medulla_utilities', 2);
INSERT INTO Internationalization (id, label, fk_language) VALUES (44, 'Utilitaires', 2);
INSERT INTO BootService (id, default_name, default_desc, fk_name, fk_desc, value) VALUES (12, 'medulla_utilities','Medulla Utilities',43,44,'KERNEL vesamenu.c32\nAPPEND ../##PULSE2_TOOLS_DIR##/utilities.menu');
