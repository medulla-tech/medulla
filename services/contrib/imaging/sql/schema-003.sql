...
UPDATE PostInstallScript SET default_name = "Deploy Medulla Agents", default_desc = "Deploy Medulla agents (SSH, OCS, VNC)" WHERE default_name LIKE "Agent Pack";
UPDATE Internationalization SET label = "Déployer les agents Medulla (SSH, OCS, VNC)" WHERE id = 20;
