...
INSERT INTO PostInstallScript (id, default_name, default_desc, fk_name, fk_desc, value) VALUES (13, "Copy agent",            "Copy Pulse agent",  1, 01, "cp /opt/winutils/Pulse-Agent-windows-FULL-latest.exe /mnt/Windows/Setup/Scripts\necho 'Agent Pulse : ' $?\n");
INSERT INTO PostInstallScript (id, default_name, default_desc, fk_name, fk_desc, value) VALUES (14, "Copy setup complete",   "Copy setupcomplete.cmd",  1, 01, "cp /opt/sysprep/SetupComplete.cmd /mnt/Windows/Setup/Scripts\necho 'setupcomplete.cmd copy : ' $?\n");
...
INSERT INTO PostInstallScript (id, default_name, default_desc, fk_name, fk_desc, value) VALUES (16, "Copy drivers",          "Copy device drivers",  1, 01, "/opt/sysprep/drivercopy Windows10\necho 'Copy device drivers : ' $?\n");
