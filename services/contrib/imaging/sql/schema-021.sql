...
-- Delete post install scripts which are no longer compatible with Medulla
...
INSERT INTO PostInstallScript (id, default_name, default_desc, fk_name, fk_desc, value) VALUES (11, "Check MountSystem",     "Show mounted folders",  1, 01, "df -h |grep medulla\n");
...
INSERT INTO PostInstallScript (id, default_name, default_desc, fk_name, fk_desc, value) VALUES (13, "Copy agent",            "Copy Medulla agent",  1, 01, "mkdir -p /mnt/Windows/Setup/Scripts\necho 'Setup scripts folder : ' $?\n\ncp /opt/winutils/Medulla-Agent-windows-FULL-latest.exe /mnt/Windows/Setup/Scripts\necho 'Agent Medulla : ' $?\n");
...
alter table ImagingServer
  CHANGE COLUMN IF EXISTS `recursive` is_recursive BOOL NOT NULL DEFAULT 1;
