...
APPEND boot=live config noswap edd=on nomodeset nosplash noprompt vga=788 fetch=tftp://%s/davos/fs.squashfs mac=%s image_uuid=%s davos_action=RESTORE_IMAGE_MULTICAST initrd=initrd.img
