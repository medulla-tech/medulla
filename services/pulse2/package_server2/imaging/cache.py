...
import pulse2.utils
import pulse2.package_server2.config
...
class UUIDCache(pulse2.utils.Singleton):
    ...
    def __init__(self):
        ...
        self.cachePath = pulse2.package_server2.config.P2PServerCP().imaging_api['uuid_cache_file']
        self.cacheLifetime = pulse2.package_server2.config.P2PServerCP().imaging_api['uuid_cache_lifetime']
