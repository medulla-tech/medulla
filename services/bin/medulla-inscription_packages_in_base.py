...
il lit tous les packages dans /var/lib/medulla/packages et les inscrit en base.
"""
import sys
import os
import logging
...
if __name__ == "__main__":
    ...
    help_message = "This program is use to add or readd in the database, the package already in /var/lib/medulla/packages"
    ...
    try:
        ...
        packagedir = os.path.join("/", "var", "lib", "medulla", "packages")
