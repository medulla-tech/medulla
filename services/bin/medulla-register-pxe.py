...
conf = {}
logoutput = open("/var/log/mmc/medulla-register-pxe.log", "a")


logging.basicConfig(
    level=logging.DEBUG,
    format="%(asctime)s %(levelname)s %(message)s",
    filename="/var/log/mmc/medulla-register-pxe.log",
    filemode="w",
)
...
class watchInventory:
    ...
    def run(self):
        ...
        self.wm.add_watch("/var/lib/medulla/imaging/inventories", mask, rec=True)
        logging.getLogger().info("watch event /var/lib/medulla/imaging/inventories")
...
if __name__ == "__main__":
    logging.getLogger().info("Start medulla-register-pxe.py")
    inifile = mmcconfdir + "/medulla/package-server/package-server.ini"
    pidfile = "/var/run/medulla-register-pxe.pid"
    cp = None
    try:
