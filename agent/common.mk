...
export RPM_SPEC_DIR = $(shell if [ "`lsb_release -sri`" == "RedHatEnterpriseServer 5" ]; then echo "packages/rpm/redhat/el5/" ; elif [ "`lsb_release -sri`" == "RedHatEnterpriseAS 4" ]; then echo "packages/rpm/redhat/el4/" ; else echo ""; fi)
