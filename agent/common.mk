...
export RPM_SPEC = mmc-agent.spec
export RPM_SPEC_DIR = $(shell if [ "`lsb_release -sri`" == "RedHatEnterpriseServer 5" ]; then echo "packages/rpm/redhat/el5/" ; elif [ "`lsb_release -sri`" == "RedHatEnterpriseAS 4" ]; then echo "packages/rpm/redhat/el4/" ; elif [ "`lsb_release -sri`" == "RedHatEnterpriseServer 5.1" ]; then echo "packages/rpm/redhat/el5/"; else echo ""; fi)
