...
class AuditActions:
    ...
    PPOLICY_DEL_USER_ATTR = u'PPOLICY_MOD_DEL_ATTR'
    PPOLICY_ADD_USER_PPOLICY_ATTR = u'PPOLICY_ADD_USER_PPOLICY_ATTR'
    PPOLICY_DEL_USER_PPOLICY_ATTR = u'PPOLICY_DEL_USER_PPOLICY_ATTR'
