...
(function(a) {
    a.fn.extend({jqEasySuggest: function(b) {
            ...
            return this.each(function() {
                function k(b) {
                    a.ajax({type: "GET", url: c.ajax_file_path, dataType: "json", data: {data: b, max_results: c.es_max_results, sql_match_type: c.sql_match_type}, success: function(b) {
                            if (b != 0) {
                            ...
                            if (a.status === 0) {
                                ...
                                alert("Requested page (" + c.ajax_file_path + ") could not be found. [404]")
                            } else if (a.status == 500) {
                                alert("Internal Server Error [500]. " + c.ajax_file_path + " has an error on the page.")
                            } else if (b === "timeout") {
