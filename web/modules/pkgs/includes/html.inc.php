                ...
                onComplete: function(id, file, responseJson){
                    ...
                    jQuery.ajax({
                        ...
                        success: function(data){
                            ...
                            jQuery("#current-actions").prepend(jQuery(document.createElement("li")).load("/mmc/modules/pkgs/includes/actions/actionprocessscript.php",{"command":data.commandcmd}));
