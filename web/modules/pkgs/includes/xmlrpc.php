<?php
if (!defined('MMC_PKGS_AUTO_TRACE_DONE')) {
    define('MMC_PKGS_AUTO_TRACE_DONE', true);
    if (function_exists('mmc_trace_module_auto_from_include')) {
        mmc_trace_module_auto_from_include('pkgs', 'mmc_dev_trace', 'INFO', 'PKGS');
    }
}
/**
...
function pkgsGetDetails($uuidpackage) {
  return xmlCall("pkgs.pkgsGetDetails", array($uuidpackage));
}
