...
// ------------------------------------------------------------------------------------------------
    $p = new PageGenerator(_T("All Logs",'base'));
...
$typecritere  =        array(
                                        _T('Backup configuration','base'),
                                        _T('Full backup requested','base'),
                                        _T('Incremental backup requested','base'),
                                        _T('Reverse SSH start','base'),
                                        _T('Reverse SSH stop','base'),
                                        _T('Restore requested','base'),
                                        _T('Manual','base'),
                                        _T('Planned','base'),
                                        _T('Restore','base'),
                                        _T('User','base'),
                                        _T('BackupPC','base'),
                                        'Agent Relay Server',
                                        _T('Deployment Transfert','base'),
                                        _T('Deployment Execution','base'),
                                        _T('Deployment Download','base'),
                                        _T('Deployment Notify','base'),
                                        _T('Deployment Error','base'),
                                        _T('Deployment Terminate','base'),
                                        _T('WOL sent','base'),
                                        _T('Menu change','base'),
                                        ...
                                        _T('Image'),
                                        _T('Quick Action'),
                                        _T('Inventory reception','base'),
                                        _T('Inventory requested','base'),
                                        _T('Inventory Deployment','base'),
                                        _T('Inventory Planned','base'),
                                        _T('Inventory Quick Action','base'),
                                        _T('Inventory User','base'),
                                        _T('Inventory Machine','base'),
                                        _T('Inventory Master','base'),
                                        _T('Inventory New machine','base'),
                                        _T('Package creation','base'),
                                        _T('Package edition','base'),
                                        _T('Package deletion','base'),
                                        _T('User','base'),
                                        _T('Package','base'),
                                        _T('Files','base'),
                                        _T('List','base'),
...
$modules = new SelectItemlabeltitle("criteriasearch", _T("Module", "base"), _T("Filter by module", "base"));
...
<div class="log-filters">
    ...
    <div class="log-filter-item"><?php echo $modules->display(); ?></div>
