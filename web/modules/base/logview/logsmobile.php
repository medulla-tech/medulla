...
// ------------------------------------------------------------------------------------------------
    $p = new PageGenerator(_("Mobile Logs"));
...
$typecritere  =        array(
                                        _T('Mobile Device','logs'),
                                        _T('Mobile Configuration','logs'),
                                        _T('Mobile Group','logs'),
                                        _T('Mobile Quick Action','logs'),
                                        _T('Mobile Deployment','logs'),
                                        _T('Mobile Message','logs'),
                                        _T('Mobile Push Message','logs'),
                                        _T('Mobile User','logs'),
                                        _T('Mobile Enrollment','logs'),
