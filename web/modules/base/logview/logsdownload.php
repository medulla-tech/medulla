...
// ------------------------------------------------------------------------------------------------
    $p = new PageGenerator(_("Transfert File Logs"));
    $p->setSideMenu($sidemenu);
    $p->display();

    $filterlogs   = "Transfertfile";
    ...
    <table border="1" cellspacing="0" cellpadding="5" class="listinfos">
        <thead>
            <tr>
                ...
                <?php 
//                     echo "<th>";
//                         echo $modules1->display();
//                     echo "</th>";
//                     echo "<th>";
//                         echo $modules2->display();
//                     echo "</th>";
                ?>
