...
if (in_array("pulse2", $_SESSION["modulesList"])) {
      ...
      echo '<label for="namepresence1" style="display:initial;">'._('All computers', 'base').'</label>';
      echo '<input type="radio" ';
      if ($computerpresence == "presence") echo "checked";
      echo ' id="namepresence2" name="namepresence" value="presence"/> ';
      echo '<label for="namepresence2" style="display:initial;">'._('Online computers', 'base').'</label>';
      echo '<input type="radio" ';
      if ($computerpresence == "no_presence") echo "checked";
      echo ' id="namepresence3" name="namepresence" value="no_presence"/> ';
      echo '<label for="namepresence3" style="display:initial;">'._('Offline computers', 'base').'</label>';
