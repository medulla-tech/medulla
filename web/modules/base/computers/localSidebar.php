...
$sidemenu->addSideMenuItem(new SideMenuItem(_("All computers glpi"), "base", "computers", "machinesListglpi", "img/machines/icn_allMachines_active.gif", "img/machines/icn_allMachines_ro.gif"));
