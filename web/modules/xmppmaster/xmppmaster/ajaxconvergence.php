...
if (isset($arraydeploy['tabdeploy']['nb_machines'])) {
    $arraydeploy['lentotal'] = $arraydeploy['tabdeploy']['nb_machines'];
}
...
$n->setItemCount($arraydeploy['lentotal'][0]);
$n->setNavBar(new AjaxNavBar($arraydeploy['lentotal'][0], $filter, "updateSearchParamformRunning"));
