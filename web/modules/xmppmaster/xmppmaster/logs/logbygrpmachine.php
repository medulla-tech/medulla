...
$p = new PageGenerator(_T("Computer deploy group", 'xmppmaster'));
$p->setSideMenu($sidemenu);
$p->display();
$ajax = new AjaxFilter(urlStrRedirect("xmppmaster/xmppmaster/ajaxlogsgrpxmpp"), "container",$params, 'logsxmppgrp');
