                    ...
                    echo "<tbody>";
                        echo "<tr>";
                            ...
                            if (isset($nbmachine)){
                             ...
                             echo "<td>";
                               echo  count($dede['share_partage'])-1;
                            echo "</td>";
                        echo "</tr>";
                    echo "</tbody>";
                echo "</table>";
        ...
        if  (count($dede['share_partage']) > 1){
            ...
            echo '<h3 id="shareowner">'._T("share user", "xmppmaster").'</h3>';
                echo '<table class="listinfos" cellspacing="0" cellpadding="5">';
                    ...
                    echo "</thead>";
                    echo "<tbody>";
                       foreach ($dede['share_partage'] as $val){
                            echo "<tr>";
                                echo "<td>";
                                if ($val['creator'] == $dede['info'][0]['creator']){
