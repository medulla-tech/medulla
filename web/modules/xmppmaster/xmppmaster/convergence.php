...
print "<br/><br/><br/>";
$ajax = new AjaxFilter(urlStrRedirect("xmppmaster/xmppmaster/ajaxconvergence"), "container", array('login' => $_SESSION['login'], 'currenttasks' => '1', 'previous'=>'index'), 'formRunning'  );
