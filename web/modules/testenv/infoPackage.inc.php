...
$page = new Page("index", _T('Liste des machines virtuelles', 'testenv'));
// $page->setFile("modules/testenv/testenv/index.php");
$submod->addPage($page);

$page = new Page("ajaxListVM", _T("Liste des Machines Virtuelles", "testenv"));
$page->setFile("modules/testenv/testenv/ajaxListVM.php");
$page->setOptions(array("AJAX"=>True, "visible"=>False, "noHeader"=>True));
$submod->addPage($page);

$page = new Page("create", _T('Créer une Machine Virtuelle', 'testenv'));
$page->setFile("modules/testenv/testenv/create.php");
$submod->addPage($page);

$page = new Page("delete", _T('Supprimer une Machine Virtuelle', 'testenv'));
$page->setFile("modules/testenv/testenv/delete.php");
$submod->addPage($page);

$page = new Page("stop", _T('Stoper une Machine Virtuelle', 'testenv'));
$page->setFile("modules/testenv/testenv/stop.php");
$submod->addPage($page);

$page = new Page("start", _T('Démarrer une Machine Virtuelle', 'testenv'));
$page->setFile("modules/testenv/testenv/start.php");
$submod->addPage($page);

$page = new Page("launch", _T('Lancer une Machine virtuelle', 'testenv'));
$page->setFile("modules/testenv/testenv/launch_vm.php");
$page->setOptions(array("AJAX"=>True, "visible"=>False, "noHeader"=>True));
$submod->addPage($page);

$page = new Page("launch2", _T('Lancer une Machine virtuelle', 'testenv'));
$page->setFile("modules/testenv/testenv/launch_vm.php");
$submod->addPage($page);

$page = new Page("edit", _T('Editer une Machine Virtuelle', 'testenv'));
