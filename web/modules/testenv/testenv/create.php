...
$page = new PageGenerator(_T("Create a virtual machine", 'testenv'));
...
$title = new SpanElement(_T("Add a virtual machine", "testenv"), "testenv-title");
...
$form->add(
    new TrFormElement(_T("Name", "testenv"), new InputTpl("name")),
