...
function extend_command($cmd_id, $start_date, $end_date, $deployment_intervals=null) {
    return xmlCall('msc.extend_command', array($cmd_id, $start_date, $end_date, $deployment_intervals));
}
