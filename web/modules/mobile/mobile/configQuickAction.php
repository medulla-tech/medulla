    ...
    <div style="width: 100%;">
        ...
        <table style="width: 100%;">
            ...
            <?
                    ...
                    echo sprintf("<td id='reset-password0' align='center' title='%s'><img src='img/actions/key.svg' height='70' width='70'></td>", _T("Click here to reset password on devices in this configuration", "mobile"));
                ?>
            </tr>
                <tr>
                <?
