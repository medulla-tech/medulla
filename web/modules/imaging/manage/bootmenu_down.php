...
if ($ret) {
    $str = sprintf(_T("Success : to move down <strong>%s</strong> in the default boot menu", "imaging"), $label);
    ...
    $str = sprintf(_T("Error : Failed to move down <strong>%s</strong> in the default boot menu", "imaging"), $label);
    xmlrpc_setfromxmppmasterlogxmpp($str,
                                    "IMG",
                                    '',
                                    0,
