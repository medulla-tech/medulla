...
$postinstalls = xmlrpc_get_all_postinstall_for_profile($location, $profileId, $start, $maxperpage, $filter);

$f = new ValidatingForm(array("action" => urlStrRedirect("imaging/manage/editProfilescript"),));
