...
if(!isset($_SESSION['parameters']))
{
    ...
    if( ! xmlrpc_linux_preseed_generator($content,$title)){
            echo "0";
    }
    else{
        new NotifyWidgetSuccess(_T("Preseed file has been created", "imaging"));
...
{
    if( ! xmlrpc_edit_linux_preseed($content,$title)){
            echo "0";
    }
    else{
        new NotifyWidgetSuccess(printf(_T("Preseed file %s has been edited", "imaging"), $title));
