...
function generate_json()
{
    ...
    jQuery.each(selector, function(id, selectedValue){
        ...
        packages[selectedValue] = {};
        jQuery.each(jQuery('#'+selectedValue+'-packages li'), function(id, package){
            packages[selectedValue][jQuery(package).attr('data-uuid')] = jQuery(package).html();
        });
    });
