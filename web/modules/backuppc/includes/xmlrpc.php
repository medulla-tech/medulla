<?php
if (!defined('MMC_BACKUPPC_AUTO_TRACE_DONE')) {
    define('MMC_BACKUPPC_AUTO_TRACE_DONE', true);
    if (function_exists('mmc_trace_module_auto_from_include')) {
        mmc_trace_module_auto_from_include('backuppc', 'mmc_dev_trace', 'INFO', 'BACKUPPC');
    }
}
...
function get_count_of_backuped_hosts() {
    return xmlCall("backuppc.get_count_of_backuped_hosts", array());
}
...
function unset_backup_for_host($uuid) {
    return xmlCall("backuppc.unset_backup_for_host", array($uuid));
}
...
function get_backupserver_for_computer($uuid) {
    return xmlCall("backuppc.get_backupserver_for_computer", array($uuid));
}
