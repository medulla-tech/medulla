...
function getMachineInfo(param) {
    return param?.cn && param?.os && param?.entity
        ? `${param.cn} ${param.os} (${param.entity})`
        : null;
}
    ...
    jQuery.ajax({
        ...
        success: function(response) {
            ...
            if (response === "0") {
                ...
                // console.log("Relance web socket viewer");
                // console.log(`0 GLOBAL_ON_FRAME`, GLOBAL_ON_FRAME);
        ...
        error: function(xhr, status, error) {
            ...
            console.log(`[${timeStamp}] Réponse du serveur :`, xhr.responseText);
        }
    });
}
...
function handleMessage(event) {
    ...
    try {
        ...
        // console.log("Message reçu (texte brut) :", message);
    }
