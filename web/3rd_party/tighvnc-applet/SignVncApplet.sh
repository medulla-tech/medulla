...
DN="cn=Mandriva Medulla 2,OU=Medulla 2 Team,O=Mandriva S.A.,L=Paris,S=France,C=FR"
NAME=VncViewer
...
rm $NAME.keystore
keytool -genkey -keyalg dsa -keysize 1024 -validity 3650 -dname "$DN" -keystore $NAME.keystore -alias "Medulla 2 - $NAME"

jarsigner -keystore $NAME.keystore -verbose $NAME.jar "Medulla 2 - $NAME"
