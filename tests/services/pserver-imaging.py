...
SERVER = xmlrpc.client.ServerProxy("%s://%s:9990/imaging_api" % (PROTOCOL, IPSERVER))
MMCAGENT = xmlrpc.client.ServerProxy(
    "%s://mmc:s3cr3t@%s:7080" % (PROTOCOL, "127.0.0.1")
)
...
MENU = {
    ...
    "images": {
        "5": {
            "uuid": "302c19d2-212b-4b9a-b04e-4fced0b83466",
            "name": "Image computer.example.net",
            "desc": "(Thu Dec  3 15:20:02 2009)",
            "post_install_script_dis": {
                "id": 2,
                "name": "...",
                "desc": "...",
                "value": "...",
...
class Imaging(unittest.TestCase):
    ...
    def test_04inventory(self):
        ...
        inventory = {
            ...
            "mem": {"upper": 128972, "lower": 636},
            "bus": {
                "0": {
                    "16": {"device": 4369, "vendor": 4660, "class": 3, "subclass": 0},
                    "9": {"device": 28688, "vendor": 32902, "class": 1, "subclass": 1},
                    "24": {"device": 4098, "vendor": 6900, "class": 5, "subclass": 0},
                    "32": {"device": 33081, "vendor": 4332, "class": 2, "subclass": 0},
                }
            },
            "macaddr": "52:54:00:C9:D1:0F",
            "ipaddr": {"ip": "192.168.21.201", "port": 1001},
            "sys": {
                "uuid": "2F6236FC76ABD2F5D88EF2B2CE720853",
                "product": "Bochs",
                "version": "-",
                "serial": "-",
                "manufacturer": "Bochs",
            },
            "bios": {"date": "01/01/2007\n", "version": "Bochs", "vendor": "Bochs"},
            "freqcpu": 2260807,
            "enclos": {"type": "1", "vendor": "Bochs"},
            "disk": {
                "0": {
                    "H": 16,
                    "C": 1023,
                    "parts": {
                        "0": {"start": 63, "length": 530082, "type": 131},
                        "1": {"start": 530145, "length": 530145, "type": 7},
                        "2": {"start": 1060290, "length": 2104515, "type": 142},
                        "4": {"start": 3164868, "length": 530082, "type": 131},
                        "5": {"start": 3695013, "length": 497952, "type": 131},
                    },
                    "S": 63,
                    "size": 63,
                }
    ...
    def test_05logClientAction(self):
        ...
        result = SERVER.logClientAction("00:0C:29:87:F7:02", 6, "boot", "booted")
        self.assertFalse(result)

        # Should return True
        result = SERVER.logClientAction("00:11:22:33:44:ff", 6, "boot", "booted")
        self.assertTrue(result)
    ...
    def atest_logClientAction(self):
        ...
        self.assertTrue("faultCode" in result and "TypeError" in result["faultCode"])
        result = SERVER.logClientAction(
            "00:11:22:33:44:ff", "level", "phase", "message"
        )
        self.assertTrue(result)
